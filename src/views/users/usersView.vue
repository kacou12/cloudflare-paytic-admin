    ...
    <div class="px-4 bg-white">
        ...
        <header class="flex justify-between items-center">
            <div class="mb-6 space-y-1">
                ...
                <p class="text-neutral-30 text-sm font-normal">Gestion des utilisateurs</p>
            </div>
        ...
        <!-- providers table -->
        <CommonDataTable :default-page="filters.page" :dynamic-width-columns="false" :total="usersData?.total ?? 0"
            :columns="usersColumn" :data="usersData?.items ?? []" @prev-page="prevPage" @next-page="nextPage"
            @go-to-page="goToPage">
        </CommonDataTable>
...
import { usersColumn } from '@/components/main/users/tables/usersColumn';
...
import { useUsersFiltersQuery } from '@/composables/queries/useUserQueries';
import { useLoaderStore } from '@/stores/useLoaderStore';
import { useRoute } from 'vue-router';


const { data: usersData, isFetched, filters, isFetching } = useUsersFiltersQuery();
