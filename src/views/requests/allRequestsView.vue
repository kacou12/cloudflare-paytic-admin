    ...
    <div class="px-4 ">
        ...
        <header class="flex justify-between items-center">
            <div class="mb-6 space-y-1">
                ...
                <h1 class="text-xl font-bold font-merriweathersans leading-6 text-black">Gestion des requetes </h1>
        ...
        <div class="flex xl:justify-between flex-col xl:flex-row my-4 ">
            <section class="xl:flex xl:flex-wrap grid grid-cols-1  md:grid-cols-2 lg:grid-cols-3  gap-2 ">
                <CommonSelect v-model="typeModel" :default-width="width >= 1366 ? 'w-fit' : 'w-full'" class=" w-full"
                    title="Filtre par type de requete" :elements="[
                        { name: 'Filtre par type  de requete', value: 'all' },
                        { name: 'Depot', value: MerchantRequestTypeEnum.Deposit },
                        { name: 'Retrait', value: MerchantRequestTypeEnum.Withdrawal }]">
                </CommonSelect>
                <CommonSelect v-model="statusModel" :default-width="width >= 1366 ? 'w-fit' : 'w-full'" class=" w-full"
                    title="Filtre par statut" :elements="[
                        ...
                        { name: 'En attente', value: MerchantRequestStatusEnum.Pending },
                        { name: 'Rejeté', value: MerchantRequestStatusEnum.Rejected },
                        { name: 'Approuvé', value: MerchantRequestStatusEnum.Approved },
