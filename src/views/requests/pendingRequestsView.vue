    ...
    <div class="px-4 ">
        ...
        <header class="flex justify-between items-center">
            <div class="mb-6 space-y-1">
                ...
                <h1 class="text-xl font-bold font-merriweathersans leading-6 text-black">Gestion des requetes en attente
                </h1>
...
const { isFetched, data: merchantRequestsData, isFetching } = useMerchantRequestsFiltersQuery(MerchantRequestStatusEnum.Pending);
